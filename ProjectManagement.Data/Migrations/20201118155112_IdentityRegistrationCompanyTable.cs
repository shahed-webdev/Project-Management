...
{
    public partial class IdentityRegistrationCompanyTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Company",
                columns: new[] { "CompanyId", "Email", "Logo", "Name", "Phone" },
                values: new object[] { 1, null, null, "Company Name", null });

            migrationBuilder.InsertData(
                table: "Registration",
                columns: new[] { "RegistrationId", "DateofBirth", "Email", "Image", "Name", "Phone", "Type", "UserName" },
