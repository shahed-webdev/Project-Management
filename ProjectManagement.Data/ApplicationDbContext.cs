...
namespace ProjectManagement.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public virtual DbSet<LogFrame1stStepParticipant> LogFrame1stStepParticipant { get; set; }
        public virtual DbSet<LogFrame1stStepCity> LogFrame1stStepCity { get; set; }
        public virtual DbSet<LogFrame2ndStepOutput> LogFrame2ndStepOutput { get; set; }
        public virtual DbSet<LogFrame2ndStepParticipant> LogFrame2ndStepParticipant { get; set; }
        public virtual DbSet<LogFrame2ndStepCity> LogFrame2ndStepCity { get; set; }
        public virtual DbSet<LogFrame3rdStepActivity> LogFrame3rdStepActivity { get; set; }
        public virtual DbSet<LogFrame3rdStepParticipant> LogFrame3rdStepParticipant { get; set; }
        public virtual DbSet<LogFrame3rdStepCity> LogFrame3rdStepCity { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new LogFrame1stStepParticipantConfiguration());
            builder.ApplyConfiguration(new LogFrame1stStepCityConfiguration());
            builder.ApplyConfiguration(new LogFrame2ndStepOutputConfiguration());
            builder.ApplyConfiguration(new LogFrame2ndStepParticipantConfiguration());
            builder.ApplyConfiguration(new LogFrame2ndStepCityConfiguration());
            builder.ApplyConfiguration(new LogFrame3rdStepActivityConfiguration());
            builder.ApplyConfiguration(new LogFrame3rdStepParticipantConfiguration());
            builder.ApplyConfiguration(new LogFrame3rdStepCityConfiguration());
